...
data = load_data('../../../../../datasets/binary/chilids_autism/childs_autism.csv', miss_values=miss)

"Labels preparations"
labels = data['Class/ASD']
...
ex.to_csv('childs_autism_external.csv')
inter.to_csv('childs_autism_internal.csv')

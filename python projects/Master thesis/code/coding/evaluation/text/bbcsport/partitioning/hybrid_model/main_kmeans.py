...
data = preprocess_text('../../../../../../datasets/text/bbcsport/bbcsport.csv')
...
"hybrid model"
data = hybrid_model(data, topics=n_clusters)
data = reduce_dimensionality(np.nan_to_num(data), 90)
...
ex.to_csv('bbcsport_external.csv')
inter.to_csv('bbcsport_internal.csv')
